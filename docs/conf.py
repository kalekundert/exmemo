# -*- coding: utf-8 -*-
#
# Ex Memoriam documentation build configuration file, created by
...
version = exmemo.__version__
# The full version, including alpha/beta/rc tags.
release = exmemo.__version__
...
man_pages = [
    ('index', 'cookiecutterproject_name', u'Ex Memoriam Documentation',
     [u'Kale Kundert'], 1)
]
